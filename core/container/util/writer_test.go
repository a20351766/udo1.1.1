...
func Test_WriteFolderToTarPackage1(t *testing.T) {
	...
	srcPath := filepath.Join(gopath, "src",
		"github.com/hyperledger/udo/examples/chaincode/java/SimpleSample")
...
func Test_WriteFolderToTarPackage2(t *testing.T) {
	...
	srcPath := filepath.Join(gopath, "src",
		"github.com/hyperledger/udo/examples/chaincode/java")
	excludeFileTypes := map[string]bool{
		".xml": true,
	}
...
func Test_WriteFolderToTarPackage3(t *testing.T) {
	...
	// since there are no node chaincode examples in udo repos
	srcPath := filepath.Join(gopath, "src",
		"github.com/hyperledger/udo/examples/chaincode/go/marbles02")
...
func Test_WriteFolderToTarPackage5(t *testing.T) {
	...
	srcPath := filepath.Join(gopath, "src",
		"github.com/hyperledger/udo/test/chaincodes/BadMetadataIgnoreHiddenFile")
...
func Test_WriteFolderToTarPackageFailure2(t *testing.T) {
	...
	// since there are no node chaincode examples in udo repos
	srcPath := filepath.Join(gopath, "src",
		"github.com/hyperledger/udo/test/chaincodes/BadMetadataInvalidIndex")
...
func Test_WriteFolderToTarPackageFailure3(t *testing.T) {
	...
	// since there are no node chaincode examples in udo repos
	srcPath := filepath.Join(gopath, "src",
		"github.com/hyperledger/udo/test/chaincodes/BadMetadataUnexpectedFolderContent")
