...
func Test_DeploymentPayload(t *testing.T) {
	...
	spec := &pb.ChaincodeSpec{
		ChaincodeId: &pb.ChaincodeID{
			Path: "github.com/hyperledger/udo/examples/chaincode/go/chaincode_example02",
		},
	}
...
func Test_DeploymentPayloadWithStateDBArtifacts(t *testing.T) {
	...
	spec := &pb.ChaincodeSpec{
		ChaincodeId: &pb.ChaincodeID{
			Path: "github.com/hyperledger/udo/examples/chaincode/go/marbles02",
		},
	}
...
func TestValidateSpec(t *testing.T) {
	...
	var tests = []struct {
		...
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "http://github.com/hyperledger/udo/examples/chaincode/go/map"}}, succ: true},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "https://github.com/hyperledger/udo/examples/chaincode/go/map"}}, succ: true},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/hyperledger/udo/examples/chaincode/go/map"}}, succ: true},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/hyperledger/udo/bad/chaincode/go/map"}}, succ: false},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: ":github.com/hyperledger/udo/examples/chaincode/go/map"}}, succ: false},
	}
...
func TestGetDeploymentPayload(t *testing.T) {
	...
	var tests = []struct {
		...
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/hyperledger/udo/examples/chaincode/go/map"}}, succ: true},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/hyperledger/udo/examples/bad/go/map"}}, succ: false},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/hyperledger/udo/test/chaincodes/BadImport"}}, succ: false},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/hyperledger/udo/test/chaincodes/BadMetadataInvalidIndex"}}, succ: false},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/hyperledger/udo/test/chaincodes/BadMetadataUnexpectedFolderContent"}}, succ: false},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/hyperledger/udo/test/chaincodes/BadMetadataIgnoreHiddenFile"}}, succ: true},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/hyperledger/udo/core/chaincode/platforms/golang/" + emptyDir}}, succ: false},
	}
...
func TestGenerateDockerBuild(t *testing.T) {
	...
	specs := make([]spec, 0)
	specs = append(specs, spec{CCName: "NoCode", Path: "path/to/nowhere", File: "/bin/warez", Mode: 0100400, SuccessExpected: false})
	specs = append(specs, spec{CCName: "invalidhttp", Path: "https://not/a/valid/path", File: "/src/github.com/hyperledger/udo/examples/chaincode/go/map/map.go", Mode: 0100400, SuccessExpected: false, RealGen: true})
	specs = append(specs, spec{CCName: "map", Path: "github.com/hyperledger/udo/examples/chaincode/go/map", File: "/src/github.com/hyperledger/udo/examples/chaincode/go/map/map.go", Mode: 0100400, SuccessExpected: true, RealGen: true})
	specs = append(specs, spec{CCName: "AutoVendor", Path: "github.com/hyperledger/udo/test/chaincodes/AutoVendor/chaincode", File: "/src/github.com/hyperledger/udo/test/chaincodes/AutoVendor/chaincode/main.go", Mode: 0100400, SuccessExpected: true, RealGen: true})
	specs = append(specs, spec{CCName: "mapBadPath", Path: "github.com/hyperledger/udo/examples/chaincode/go/map", File: "/src/github.com/hyperledger/udo/examples/bad/path/to/map.go", Mode: 0100400, SuccessExpected: false})
	specs = append(specs, spec{CCName: "mapBadMode", Path: "github.com/hyperledger/udo/examples/chaincode/go/map", File: "/src/github.com/hyperledger/udo/examples/chaincode/go/map/map.go", Mode: 0100555, SuccessExpected: false})
