...
func getLaunchConfigs(t *testing.T, auth accesscontrol.Authenticator) {
	...
	if envs[0] != "CORE_CHAINCODE_ID_NAME=mycc:v0" || envs[1] != "CORE_PEER_TLS_ENABLED=true" ||
		envs[2] != "CORE_TLS_CLIENT_KEY_PATH=/etc/hyperledger/udo/client.key" || envs[3] != "CORE_TLS_CLIENT_CERT_PATH=/etc/hyperledger/udo/client.crt" ||
		envs[4] != "CORE_PEER_TLS_ROOTCERT_FILE=/etc/hyperledger/udo/peer.crt" ||
