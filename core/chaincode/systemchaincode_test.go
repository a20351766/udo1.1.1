...
import (
	...
	"github.com/hyperledger/udo/core/scc/samplesyscc"
	...
	sysccs := []*scc.SystemChaincode{
		{
			Enabled:   true,
			Name:      "sample_syscc",
			Path:      "github.com/hyperledger/udo/core/scc/samplesyscc",
			InitArgs:  [][]byte{},
...
func deploySampleSysCC(t *testing.T, ctxt context.Context, chainID string) error {
	...
	url := "github.com/hyperledger/udo/core/scc/sample_syscc"
