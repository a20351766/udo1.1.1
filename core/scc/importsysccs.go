...
import (
	...
	"github.com/hyperledger/udo/core/scc/escc"
	"github.com/hyperledger/udo/core/scc/lscc"
	"github.com/hyperledger/udo/core/scc/qscc"
	"github.com/hyperledger/udo/core/scc/vscc"
)
...
var systemChaincodes = []*SystemChaincode{
	{
		Enabled:           true,
		Name:              "cscc",
		Path:              "github.com/hyperledger/udo/core/scc/cscc",
		InitArgs:          [][]byte{[]byte("")},
	...
	},
	{
		Enabled:           true,
		Name:              "lscc",
		Path:              "github.com/hyperledger/udo/core/scc/lscc",
		InitArgs:          [][]byte{[]byte("")},
	...
	},
	{
		Enabled:   true,
		Name:      "escc",
		Path:      "github.com/hyperledger/udo/core/scc/escc",
		InitArgs:  [][]byte{[]byte("")},
	...
	},
	{
		Enabled:   true,
		Name:      "vscc",
		Path:      "github.com/hyperledger/udo/core/scc/vscc",
		InitArgs:  [][]byte{[]byte("")},
	...
	},
	{
		Enabled:           true,
		Name:              "qscc",
		Path:              "github.com/hyperledger/udo/core/chaincode/qscc",
		InitArgs:          [][]byte{[]byte("")},
