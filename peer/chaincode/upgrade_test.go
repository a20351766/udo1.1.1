...
func TestUpgradeCmd(t *testing.T) {
	...
	args := []string{"-n", "example02", "-p", "github.com/hyperledger/udo/examples/chaincode/go/chaincode_example02",
	...
	args = []string{"-C", "mychannel", "-n", "example02", "-p", "github.com/hyperledger/udo/examples/chaincode/go/chaincode_example02",
		"-v", "anotherversion", "-c", "{\"Function\":\"init\",\"Args\": [\"param\",\"1\"]}"}
	cmd.SetArgs(args)
	err = cmd.Execute()
...
func TestUpgradeCmdSendTXFail(t *testing.T) {
	...
	args := []string{"-C", "mychannel", "-n", "example02", "-p", "github.com/hyperledger/udo/examples/chaincode/go/chaincode_example02", "-v", "anotherversion", "-c", "{\"Function\":\"init\",\"Args\": [\"param\",\"1\"]}"}
	cmd.SetArgs(args)
