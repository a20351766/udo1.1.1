...
type UdoMSPConfig struct {
	...
	// UdoNodeOUs contains the configuration to distinguish clients from peers from orderers
	// based on the OUs.
	UdoNodeOUs *UdoNodeOUs `protobuf:"bytes,11,opt,name=UdoNodeOUs" json:"UdoNodeOUs,omitempty"`
}
...
func (*UdoMSPConfig) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*UdoCryptoConfig) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func (*UdoOUIdentifier) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{7} }
...
type UdoNodeOUs struct {
	...
	ClientOUIdentifier *UdoOUIdentifier `protobuf:"bytes,2,opt,name=clientOUIdentifier" json:"clientOUIdentifier,omitempty"`
	// OU Identifier of the peers
	PeerOUIdentifier *UdoOUIdentifier `protobuf:"bytes,3,opt,name=peerOUIdentifier" json:"peerOUIdentifier,omitempty"`
}
...
func (*UdoNodeOUs) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{8} }
