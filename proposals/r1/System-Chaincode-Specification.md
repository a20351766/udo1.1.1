...
behaviors of the udo such as timer service or naming service.
...
Execution mechanisms. The abstractions provided by the Udo for these
...
The udo provides a basic interface for a “vm”. The Docker container
is implemented on top of this abstraction. The “vm” ([vm interface](https://github.com/hyperledger/udo/blob/master/core/container/controller.go))
