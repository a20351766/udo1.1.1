...
#    @doNotDecompose
    @FAB-184
  	Scenario Outline: Basic deploy endorsement for chaincode through GRPC to multiple endorsers
        ...
        When user "binhn" creates a chaincode spec "cc_spec" of type "GOLANG" for chaincode "github.com/hyperledger/udo/examples/chaincode/go/chaincode_example02" with args
...
#    @doNotDecompose
	...
	Scenario Outline: Advanced deploy endorsement with ESCC for chaincode through GRPC to single endorser
        ...
        When user "binhn" creates a chaincode spec of type "GOLANG" for chaincode "github.com/hyperledger/udo/examples/chaincode/go/chaincode_example02" aliased as "cc_spec" with args
             | funcName | arg1 |  arg2 | arg3 | arg4 |
             |   init   |  a   |  100  |  b   |  200 |
