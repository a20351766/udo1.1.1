...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n%org.hyperledger.udo.protos.ordererZ,github.com/hyperledger/udo/protos/orderer'))
try:
