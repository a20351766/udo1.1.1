...
def getMSPConfig(org, directory):
    ...
    udoMSPConfig = msp_config_pb2.UdoMSPConfig(admins=adminCerts, root_certs=cacerts, name=org.name, tls_root_certs=tls_root_certs)
    mspConfig = msp_config_pb2.MSPConfig(config=udoMSPConfig.SerializeToString(), type=0)
    return mspConfig
