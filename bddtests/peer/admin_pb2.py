...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\"org.hyperledger.udo.protos.peerB\014AdminPackageZ)github.com/hyperledger/udo/protos/peer'))
try:
