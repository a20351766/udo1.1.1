...
other elements in a Hyperledger Udo blockchain network.
...
Hyperledger Udo blockchain network. When a peer is first created, it has
...
We'll see a little later why the concept of **channels** in Hyperldeger Udo
...
Hyperledger Udo -- all transactions are marshalled into in a strict order --
