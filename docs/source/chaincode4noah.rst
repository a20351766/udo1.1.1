...
.. code:: bash
    ...
    peer chaincode package -n mycc -p github.com/hyperledger/udo/examples/chaincode/go/chaincode_example02 -v 0 -s -S -i "AND('OrgA.admin')" ccpack.out
...
<https://github.com/hyperledger/udo/blob/master/core/scc/importsysccs.go>`_
...
3. `QSCC <https://github.com/hyperledger/udo/tree/master/core/scc/qscc>`_
   ...
   transactions.
4. `ESCC <https://github.com/hyperledger/udo/tree/master/core/scc/escc>`_
   Endorsement system chaincode handles endorsement by signing the transaction
   proposal response.
5. `VSCC <https://github.com/hyperledger/udo/tree/master/core/scc/vscc>`_
