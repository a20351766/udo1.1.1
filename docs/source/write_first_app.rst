...
the latest stable Udo images and available utilities.
...
Run the following command to install the Udo dependencies for the applications.
...
will spin up our various Udo entities and launch a smart contract container for
