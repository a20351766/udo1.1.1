...
``hyperledger/udo-baseimage``, ``hyperledger/udo-peer`` and
``hyperledger/udo-orderer``. Rather than pull from Docker Hub, you
...
environment <dev-setup/devenv.html>`__. Then from the udo directory
...
Navigate to the udo/docs directory in your vagrant environment and
start your network:
...
.. code:: bash
    ...
    root@ccd3308afc73:/opt/gopath/src/github.com/hyperledger/udo/peer#
...
.. code:: bash
    ...
    CORE_PEER_ADDRESS=peer0:7051 peer chaincode install -n mycc -p github.com/hyperledger/udo/examples/chaincode/go/chaincode_example02 -v v0
...
.. code:: bash
    ...
    CORE_PEER_ADDRESS=peer0:7051 peer chaincode instantiate -o orderer:5005 -C myc -n mycc -p github.com/hyperledger/udo/examples/chaincode/go/chaincode_example02 -v v0 -c '{"Args":["init","a","100","b","200"]}'
...
.. code:: bash
    ...
    CORE_PEER_ADDRESS=peer1:7051 peer chaincode install -n mycc -p github.com/hyperledger/udo/examples/chaincode/go/chaincode_example02 -v v0
