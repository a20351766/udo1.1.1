...
#################################################################################
    ...
    def runIt(self, command, scriptName):
        cmd = "/opt/gopath/src/github.com/hyperledger/udo/test/regression/daily/chaincodeTests/%s %s %s %s %s %s"% (scriptName, self.CHANNEL_NAME, self.CHANNELS, self.CHAINCODES, self.ENDORSERS, command)
        output = check_output(["docker exec cli {0}".format(cmd)], shell=True)
        return output

#####Begin tests for different chaincode samples that exist in udoExamples folder ###################
    def test_AFAB3843_Create_Join_Channel(self):
        ...
        '''
        output = self.runIt("create", "udoFeatureChaincodes/create_join_channel.sh")
        ...
        output = self.runIt("join", "udoFeatureChaincodes/create_join_channel.sh")
    ...
    def test_FAB3794_example02_invoke_query_inaloop_onallpeers(self):
        ...
        '''
        output = self.runIt("install", "udoFeatureChaincodes/e2e_test_example02.sh")
        ...
        output = self.runIt("instantiate", "udoFeatureChaincodes/e2e_test_example02.sh")
        ...
        output = self.runIt("invokeQuery", "udoFeatureChaincodes/e2e_test_example02.sh")
    ...
    def test_FAB3791_example03_negative_test_disallow_write_attempt_in_query(self):
        ...
        '''
        output = self.runIt("install", "udoFeatureChaincodes/e2e_test_example03.sh")
        self.assertIn("successfully", output)
        output = self.runIt("instantiate", "udoFeatureChaincodes/e2e_test_example03.sh")
        self.assertIn("successfully", output)
        output = self.runIt("invokeQuery", "udoFeatureChaincodes/e2e_test_example03.sh")
    ...
    def test_FAB3796_example04_chaincode_to_chaincode_call_on_occurrence_of_an_event(self):
        ...
        '''
        output = self.runIt("install", "udoFeatureChaincodes/e2e_test_example04.sh")
        self.assertIn("successfully", output)
        output = self.runIt("instantiate", "udoFeatureChaincodes/e2e_test_example04.sh")
        self.assertIn("successfully", output)
        output = self.runIt("invokeQuery", "udoFeatureChaincodes/e2e_test_example04.sh")
        self.assertIn("successfully", output)
    ...
    def test_FAB3797_example05_chaincode_to_chaincode_call_on_same_and_different_channel(self):
        ...
        '''
        output = self.runIt("install", "udoFeatureChaincodes/e2e_test_example05.sh")
        ...
        output = self.runIt("instantiate", "udoFeatureChaincodes/e2e_test_example05.sh")
        self.assertIn("successfully", output)
        output = self.runIt("invokeQuery", "udoFeatureChaincodes/e2e_test_example05.sh")
        self.assertIn("successfully", output)
    ...
    def test_FAB3792_marbles02_init_query_transfer_marbles(self):
        ...
        '''
        output = self.runIt("install", "udoFeatureChaincodes/e2e_test_marbles02.sh")
        self.assertIn("successfully", output)
        output = self.runIt("instantiate", "udoFeatureChaincodes/e2e_test_marbles02.sh")
        self.assertIn("successfully", output)
        output = self.runIt("initMarble1", "udoFeatureChaincodes/e2e_test_marbles02.sh")
        self.assertIn("successful", output)
        output = self.runIt("queryMarble1", "udoFeatureChaincodes/e2e_test_marbles02.sh")
        self.assertIn("successful", output)
        output = self.runIt("initMarble2", "udoFeatureChaincodes/e2e_test_marbles02.sh")
        self.assertIn("successful", output)
        output = self.runIt("queryMarble2", "udoFeatureChaincodes/e2e_test_marbles02.sh")
        self.assertIn("Query marble2 on PEER2 on channel0 on chaincode mymarbles020 is successful", output)
        output = self.runIt("txfrMarble", "udoFeatureChaincodes/e2e_test_marbles02.sh")
        self.assertIn("Txfr marble1 on PEER2 on channel0 on chaincode mymarbles020 to JERRY is successful", output)
        output = self.runIt("queryAfterTxfrMarble", "udoFeatureChaincodes/e2e_test_marbles02.sh")
    ...
    def test_FAB3793_chaincodeAPIDriver_exercise_chaincode_api_calls_as_invoke_functions(self):
        ...
        '''
        output = self.runIt("install", "udoFeatureChaincodes/e2e_test_ccapidriver.sh")
        self.assertIn("successfully", output)
        output = self.runIt("instantiate", "udoFeatureChaincodes/e2e_test_ccapidriver.sh")
        self.assertIn("successfully", output)
        output = self.runIt("invoke_getTxTimeStamp", "udoFeatureChaincodes/e2e_test_ccapidriver.sh")
        self.assertIn("successful", output)
        output = self.runIt("invoke_getBinding", "udoFeatureChaincodes/e2e_test_ccapidriver.sh")
        self.assertIn("successful", output)
        output = self.runIt("invoke_getCreator", "udoFeatureChaincodes/e2e_test_ccapidriver.sh")
        self.assertIn("successful", output)
        output = self.runIt("invoke_getSignedProposal", "udoFeatureChaincodes/e2e_test_ccapidriver.sh")
        self.assertIn("successful", output)
        output = self.runIt("invoke_getTransient", "udoFeatureChaincodes/e2e_test_ccapidriver.sh")
        self.assertIn("successful", output)
    ...
    def test_FAB3793_chaincodeAPIDriver_2_exercise_chaincode_api_calls_as_direct_calls(self):
        ''' Calling functions in shim/chaincode.go.
        '''
        output = self.runIt("install", "udoFeatureChaincodes/e2e_test_ccapidriver_two.sh")
        self.assertIn("successfully", output)
        output = self.runIt("instantiate", "udoFeatureChaincodes/e2e_test_ccapidriver_two.sh")
        self.assertIn("successfully", output)
        output = self.runIt("invoke_getTxTimeStamp", "udoFeatureChaincodes/e2e_test_ccapidriver_two.sh")
        self.assertIn("successful", output)
        output = self.runIt("invoke_getBinding", "udoFeatureChaincodes/e2e_test_ccapidriver_two.sh")
        self.assertIn("successful", output)
        output = self.runIt("invoke_getCreator", "udoFeatureChaincodes/e2e_test_ccapidriver_two.sh")
        self.assertIn("successful", output)
        output = self.runIt("invoke_getSignedProposal", "udoFeatureChaincodes/e2e_test_ccapidriver_two.sh")
        self.assertIn("successful", output)
        output = self.runIt("invoke_getTransient", "udoFeatureChaincodes/e2e_test_ccapidriver_two.sh")
        self.assertIn("successful", output)
