...
# RUN END-to-END Test
#####################
rm -rf ${WORKSPACE}/gopath/src/github.com/hyperledger/udo-sdk-node

WD="${WORKSPACE}/gopath/src/github.com/hyperledger/udo-sdk-node"
...
echo "UDO NODE SDK COMMIT ========> " $NODE_SDK_COMMIT >> ${WORKSPACE}/gopath/src/github.com/hyperledger/commit_history.log
