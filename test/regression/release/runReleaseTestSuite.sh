...
DAILYDIR="$GOPATH/src/github.com/hyperledger/udo/test/regression/daily"
RELEASEDIR="$GOPATH/src/github.com/hyperledger/udo/test/regression/release"

export UDO_ROOT_DIR=$GOPATH/src/github.com/hyperledger/udo

cd $UDO_ROOT_DIR || exit
