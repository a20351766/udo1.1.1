...
Scenario: FAB-3851: Message Payloads Greater than 1MB
    Given I have a bootstrapped udo network
    When a user deploys chaincode
    Then the chaincode is deployed

@daily
Scenario: FAB-4686: Test taking down all kafka brokers and bringing back last 3
    Given I have a bootstrapped udo network of type kafka
    And I wait "60" seconds
    When a user deploys chaincode at path "github.com/hyperledger/udo/examples/chaincode/go/chaincode_example02" with ["init","a","1000","b","2000"] with name "mycc"
