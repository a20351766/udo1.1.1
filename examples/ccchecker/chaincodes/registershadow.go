...
import (
	...
	nkpi "github.com/hyperledger/udo/examples/ccchecker/chaincodes/newkeyperinvoke/shadow"
)

//all the statically registered shadow chaincodes that can be used
var shadowCCs = map[string]ShadowCCIntf{
	"github.com/hyperledger/udo/examples/ccchecker/chaincodes/newkeyperinvoke": &nkpi.NewKeyPerInvoke{},
}
